...
param$project = "N1729"
param$organism = "mm" # Organism: hg or mm
param$path_project= "projects/N1730/"
param$path_matrix = "projects/N1730/filtered_feature_bc_matrix.h5"
param$gmt_file = "gmt_files/c2.all.v7.1.symbols.gmt"
...
# feature_matrix <- Read10X_h5(param$path_matrix)
...
seurat.data <- Read10X(data.dir = "projects/N1730/filtered_feature_bc_matrix/")
# Initialize the Seurat object with the raw (non-normalized data).
seurat <- CreateSeuratObject(counts = seurat.data, project = "N1729", min.cells = 3, min.features = 200)
seurat
...
seurat@meta.data$sample <- factor(param$project, levels = param$project)

seurat@misc$experiment <- list(
  experiment_name = param$project,
...
cerebroApp::exportFromSeurat(
  seurat,
  experiment_name = param$project,
  #file = paste0(param$path_project,'cerebro_export,/', param$project, '_', Sys.Date(), '.crb'),
  file = paste0('cerebro_export/', param$project, '_', Sys.Date(), '.crb'),
  organism = param$organism,
...
#saveRDS(seurat, paste0(param$path_project,'seurat_export/', param$project, '_', Sys.Date(), '.rds'))
# Problem with too long paths
saveRDS(seurat, paste0(param$project, '_', Sys.Date(), '.rds'))
```